<?php
class Skbpm extends CI_Controller {
	...
	public function index()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$this->load->view('surat/skbpm/cari_data_penduduk');
			$this->load->view('template/footer');
		} else {
			$data['title'] = 'Buat Surat Keterangan Belum Pernah Menikah';
			$data['jumlah_pengajuan'] = $this->pengajuan_model->get_jumlah_pengajuan();
			$data['penduduk'] = $this->penduduk_model->get_penduduk($this->input->post('keyword'));
			$this->load->view('template/header', $data);
			$this->load->view('template/menu', $data);
			$this->load->view('surat/skbpm/cari_data_penduduk');
			$this->load->view('surat/skbpm/tampil_data_penduduk', $data);
			$this->load->view('template/footer');
		}
	}
